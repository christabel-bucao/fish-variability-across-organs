...
if (!params$combat) {
  input.selection.path <- file.path(params$input.selection.rds.path, "no_combat")
} else {
  input.selection.path <- file.path(params$input.selection.rds.path, "combat")
}
...
```{r import-tau}
if (!params$combat) {
  input.tau.path <- file.path(params$input.tau.rds.path, "no_combat")
} else {
  input.tau.path <- file.path(params$input.tau.rds.path, "combat")
}
