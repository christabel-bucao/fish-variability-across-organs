...
## No ComBat
no_combat_dir <- file.path(params$output.rds.path,"no_combat")
if (!dir.exists(no_combat_dir)) { dir.create(no_combat_dir, recursive=TRUE, showWarnings=FALSE) }

saveRDS(data.qc2.cor, 
        file.path(no_combat_dir, 
...
## With ComBat
combat_dir <- file.path(params$output.rds.path, "combat")
if (!dir.exists(combat_dir)) { dir.create(combat_dir, recursive=TRUE, showWarnings=FALSE) }

saveRDS(data.qc2.cor.combat, 
        file.path(combat_dir, 
                  paste(params$species, 
                        params$min.replicates, "reps",
                        "data.qc2.cor.rds", sep="_")))
