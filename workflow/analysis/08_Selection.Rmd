...
if (!params$combat) {
  input.samples.path <- file.path(params$input.samples.rds.path, "no_combat")
} else {
  input.samples.path <- file.path(params$input.samples.rds.path, "combat")
}
...
if (!params$combat) {
  input.variability.path <- file.path(params$input.variability.rds.path, "no_combat")
} else {
  input.variability.path <- file.path(params$input.variability.rds.path, "combat")
}
