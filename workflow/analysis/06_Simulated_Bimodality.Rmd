...
zscore.matrix.tissue1 <- compute_zscore(expr.matrix.tissue1)
```
...
bimodality.test.tissue1$VarRankBin <- ceiling(bimodality.test.tissue1$VarRank*10)/10
bimodality.test.tissue1$VarRankBin[round(bimodality.test.tissue1$VarRankBin,1)==0.0] <- 0.1
```
...
bimodality.test.tissue1$BIBin<- ceiling(bimodality.test.tissue1$BI*10)/10
...
zscore.matrix.tissue1.2 <- compute_zscore(expr.matrix.tissue1.2)
```
...
bimodality.test.tissue1.2$VarRankBin <- ceiling(bimodality.test.tissue1.2$VarRank*10)/10
bimodality.test.tissue1.2$VarRankBin[round(bimodality.test.tissue1.2$VarRankBin,1)==0.0] <- 0.1
```
...
bimodality.test.tissue1.2$BIBin <- ceiling(bimodality.test.tissue1.2$BI*10)/10
